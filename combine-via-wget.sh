...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-budgie-theme-fluent"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-fluent/iso-profile
"
echo
